 ...
 */
final class Version20201026150950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66F675F31C FOREIGN KEY (author_id) REFERENCES user (id)');
